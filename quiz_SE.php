...
<body>
  ...
  <div class="quiz-header">
    <h2 id="question5">Question Text</h2>
    <ul>
      <li>
        <input type="radio" name="answer" id="a5" class="answer5">
        <label for="a" id="a_text5">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="b1" class="answer5">
        <label for="b" id="b_text5">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="c1" class="answer5">
        <label for="c" id="c_text5">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="d5" class="answer5">
        <label for="d" id="d_text5">Answer</label>
      </li>
...
<footer>
  ...
  <!-- JS File -->
  <script type="text/javascript" src="js/script.js"></script>
  <script src="js/quizscript_SE.js"></script>
