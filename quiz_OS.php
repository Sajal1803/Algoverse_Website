...
<body>
  ...
  <div class="quiz-header">
    <h2 id="question4">Question Text</h2>
    <ul>
      <li>
        <input type="radio" name="answer" id="a4" class="answer4">
        <label for="a" id="a_text4">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="b4" class="answer4">
        <label for="b" id="b_text4">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="c4" class="answer4">
        <label for="c" id="c_text4">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="d4" class="answer4">
        <label for="d" id="d_text4">Answer</label>
      </li>
...
<footer>
  ...
  <!-- JS File -->
  <script type="text/javascript" src="js/script.js"></script>
  <script src="js/quizscript_OS.js"></script>
