...
<body>
  ...
  <div class="quiz-header">
    <h2 id="question1">Question Text</h2>
    <ul>
      <li>
        <input type="radio" name="answer" id="a1" class="answer1">
        <label for="a" id="a_text1">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="b1" class="answer1">
        <label for="b" id="b_text1">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="c1" class="answer1">
        <label for="c" id="c_text1">Answer</label>
      </li>

      <li>
        <input type="radio" name="answer" id="d1" class="answer1">
        <label for="d" id="d_text1">Answer</label>
      </li>
...
<footer>
  ...
  <!-- JS File -->
  <script type="text/javascript" src="js/script.js"></script>
  <script src="js/quizscript_DSA.js"></script>
